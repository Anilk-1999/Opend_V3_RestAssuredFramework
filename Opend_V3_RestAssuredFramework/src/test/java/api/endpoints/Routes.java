...
/*--------------------------------------------------------------Creatives---------------------------------------------------------------------*/ 
    ...
    public static String insertCratives      = base_url+"/creatives/insert-creative";
    public static String listCreatives       = base_url+"/creatives/list-creatives?advertiser_id=1";
    public static String getCreatives        = base_url+"/creatives/get-creative?inserted_id=1&template_id=1";
    public static String updateCreatives     = base_url+"/creatives/update-creative";
    public static String updateCreativeStatus= base_url+"/creatives/update-creative-active-status?inserted_id=1&status=1";	
    public static String deleteCreatives     = base_url+"/creatives/delete-creative-template?inserted_id=1";
...
/*------------------------------------------------------------Suppressions--------------------------------------------------------------------------*/  
    ...
    public static String downloadSuppression              = base_url+"/suppression/download-suppression?suppression_list_id=233&client_user_id=1";
    public static String suppressionList                  = base_url+"/suppression/list-suppression";
    public static String getSuppressionStatus             = base_url+"/suppression/get-suppression-status?client_type=1&client_id=233";	
